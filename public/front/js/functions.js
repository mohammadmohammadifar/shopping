...
jQuery($=> {
        ...
        setTimeout(function () {
            ...
            switch (n) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ratingText.text('بسیار خوب!');
                    break;
                case 4:
                    ratingText.text('عالی!');
            }
        }, 180);
    }
    ...
    $(()=> {
        $tooltip.tooltipster({
            ...
            offset: [0, 0],
            animation: 'fade',
            content:'برای بستن اینجا کلیک کنید یا ESC را فشار دهید!',
            delay: 20,
            theme: 'tooltipster-light',
            repositionOnScroll: true,
            // change the content of tooltip in all pages
            // functionBefore: function (instance, helper) {
            //     instance.content('برای بستن اینجا کلیک کنید یا ESC را فشار دهید!');
            // }
        });
    });
    /*Wow Animations*/
    ...
    if (typed.length) {
        let classicStartup = new Typed('#typed-text', {
            strings: ['توسعه دهنده فرانت اند', 'طراح فرانت اند', 'استاد فرانت اند', 'طراح خلاق', 'سازنده خلاق'],
            typeSpeed: 45,
            backSpeed: 22,
            backDelay: 1000,
...
$(document).ready(function (){
    $("#rev_creative li[data-index='rs-01'] .tp-bgimg").css("transform","scaleX(-1)");
    $("#rev_creative li[data-index='rs-03'] .tp-bgimg").css("transform","scaleX(-1)");
    $("#vertical-bullets li[data-index='rs-01'] .tp-bgimg").css("transform","scaleX(-1)");
    $("#vertical-bullets li[data-index='rs-03'] .tp-bgimg").css("transform","scaleX(-1)");
    $("#rev_arrows li[data-index='rs-second'] .tp-bgimg").css("transform","scaleX(-1)");
})