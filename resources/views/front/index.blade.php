                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 wow fadeIn" data-wow-delay="300ms">
                        <div class="shopping-box bottom30">
                            <div class="image sale" data-sale="40">
                                <img src="{{ url(env('UPLOAD_IMAGE'). $product->primary_image) }}" alt="shop">
                            ...
                            <div class="shop-content text-center">
                                ...
                                <h4 class="price-product">{{ $product->variations()->first()->price }}</h4>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center wow fadeIn" data-wow-delay="300ms">
                    ...
                    <div class="col-md-8 offset-md-2-rtl heading_space">
                        <p>اگر طراح بخواهد دنبال متن های مرتبط بگردد تمرکزش از روی کار اصلی برداشته میشود و اینکار زمان بر
                            خواهد بود.</p>
                    </div>
                </div>
